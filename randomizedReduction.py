...
from renderGraphPath import extract_score_context, attach_render_payload, render_best_path, render_interwoven_primary_secondary, restrict_path_to_core, restore_path_notes
from visualizeGraph import visualize_subgraph
from highlightReduction import save_selected_path_manifest, write_highlighted_score
...
def graph_reducer(args):
    ...
    try:
        ...
        if args.annotate:
            ...
            annotated_out = Path(f'{ANNOTATED_DIR}{piece_name}_{args.method}_selected_notes.musicxml')
